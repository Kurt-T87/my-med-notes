...
pmid: 42049437
zotero_link: "zotero://select/items/0_WZEAUWKV"
...
- **Zotero**: [点击跳转 Zotero 库](zotero://select/items/0_WZEAUWKV)
...
## 📄 Abstract
Breast cancer is the most commonly diagnosed malignancy among women worldwide. While survival outcomes have improved substantially over time, recurrence remains a significant concern, especially in estrogen receptor-positive (ER<sup>+</sup>) disease. Although most recurrences occur within five years of initial treatment, ER<sup>+</sup> tumors carry a persistent risk of late relapse due to tumor dormancy. Very late recurrences occurring decades after remission are rare and poorly characterized.
